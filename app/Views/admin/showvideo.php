                        ...
                        <?php foreach ($videos as $get) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-secondary" data-toggle="modal" data-target="#showvideo" onclick="openvideo('<?= site_url('vdo/' . $courses['url'] . '/allvdo/' . $get['url']); ?>','<?= $get['name']; ?>')">ดูคลิป</button>
